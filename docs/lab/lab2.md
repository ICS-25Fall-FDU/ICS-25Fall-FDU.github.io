...
这是一款全新的代码世界冒险游戏，相比 csapp 的经典款BombLab具有更高的可玩性。在本代码世界冒险游戏中，你将扮演一位精通汇编语言/ linux / gdb / 数据结构的幸存者，在一座即将走向末路的“AI城市”中，通过自己的智慧与胆量发现隐藏在混乱的 x86 汇编背后的真相......
...
**gdb**（GNU symbolic debugger），是linux下常用的程序调试器。本次lab的主力之一。
